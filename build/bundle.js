...
$(".selectShop").on("click", function () {
    var statu = $(this).is(':checked');
    var selectList = $(this).parents(".shop").find(".select");
    if (statu) {
...
$(".delete").on("click", function () {
    ...
    var self = this;
    $(self).trigger("deleteClick", function (statu) {
        if (statu === true) {
            goods.animate({
                height:0
            },250,function(){
                $(this).hide();
                $(this).next('hr').hide();//隐藏
            });
        }
    });
});

//$(".delete").on("deleteClick", function (e, callback) {
//    setTimeout(function () {
//        callback(true);
//    }, 1000);
//
 ...
 */
var $ = __webpack_require__(0);
var selectChange = __webpack_require__(1);
//num
 ...
 */
__webpack_require__(5); // 引入样式
__webpack_require__(4); //注册数量价格方法
__webpack_require__(2); //注册按钮Model
__webpack_require__(1); //注册select
__webpack_require__(3); //注册hook
